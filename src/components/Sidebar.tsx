                        ...
                        {MENU_ITEMS.map((item) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`w-full flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-white/5 transition-all group ${currentView === item.id ? "bg-white/10 text-white" : "text-white/70 hover:text-white"}`}
                                >
